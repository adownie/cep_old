...
class HeadwayWebFontsLoader {
	...
	public static function get_fonts_in_use() {
		...
		$cache = HeadwaySkinOption::get('webfont-cache');
		...
		return HeadwaySkinOption::get('webfont-cache');
	...
	public static function cache() {
		...
		return HeadwaySkinOption::set('webfont-cache', $sorted_webfonts);
	...
	public static function flush_cache() {
		...
		return HeadwaySkinOption::delete('webfont-cache');

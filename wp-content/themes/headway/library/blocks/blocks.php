...
class HeadwayBlocks {
	...
	public static function setup_block_actions() {
		...
		/* If cache exists then use it */
			if ( HeadwaySkinOption::get('cached', 'block-actions-cache', false) && !(headway_get('ve-iframe') && HeadwayCapabilities::can_user_visually_edit()) ) {

				self::$block_actions = array(
					'init' => HeadwaySkinOption::get('init', 'block-actions-cache', array()),
					'enqueue' => HeadwaySkinOption::get('enqueue', 'block-actions-cache', array()),
					'dynamic-js' => HeadwaySkinOption::get('dynamic-js', 'block-actions-cache', array()),
					'dynamic-css' => HeadwaySkinOption::get('dynamic-css', 'block-actions-cache', array()),
					'block-objects' => HeadwaySkinOption::get('block-objects', 'block-actions-cache', array())
				);
		...
		/* Set the cache */
			HeadwaySkinOption::set('init', self::$block_actions['init'], 'block-actions-cache');
			HeadwaySkinOption::set('enqueue', self::$block_actions['enqueue'], 'block-actions-cache');
			HeadwaySkinOption::set('dynamic-js', self::$block_actions['dynamic-js'], 'block-actions-cache');
			HeadwaySkinOption::set('dynamic-css', self::$block_actions['dynamic-css'], 'block-actions-cache');
			HeadwaySkinOption::set('block-objects', self::$block_actions['block-objects'], 'block-actions-cache');

			HeadwaySkinOption::set('cached', true, 'block-actions-cache');
		...
		public static function clear_block_actions_cache() {
			...
			HeadwaySkinOption::set('init', array(), 'block-actions-cache');
			HeadwaySkinOption::set('enqueue', array(), 'block-actions-cache');
			HeadwaySkinOption::set('dynamic-js', array(), 'block-actions-cache');
			HeadwaySkinOption::set('dynamic-css', array(), 'block-actions-cache');
			HeadwaySkinOption::set('block-objects', array(), 'block-actions-cache');

			return HeadwaySkinOption::set('cached', false, 'block-actions-cache');

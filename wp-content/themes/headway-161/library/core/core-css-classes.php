...
function headway_body_class() {
	...
	if(is_ie(6) && !headway_is_caching()): $c[] = 'ie6'; $c[] = 'ie'; endif;
	if(is_ie(7) && !headway_is_caching()): $c[] = 'ie7'; $c[] = 'ie'; endif;
	if(is_ie(8) && !headway_is_caching()): $c[] = 'ie8'; endif;

	if(headway_visual_editor_open()) $c[] = 'headway-visual-editor-open';
		
	if(headway_get_option('active-skin') && !isset($_GET['skin-preview']))
		$c[] = 'skin-'.headway_get_option('active-skin');
			
	elseif($_GET['skin-preview'] != headway_get_option('active-skin') && headway_can_visually_edit())
		$c[] = 'skin-'.$_GET['skin-preview'];

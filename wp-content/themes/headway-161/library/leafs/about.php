...
?>
	...
	<div id="image-tab-<?php echo $leaf['id'] ?>">
		<table class="tab-options" id="leaf-options-<?php echo $leaf['id'] ?>-image">
			...
			<tr>					
				<th scope="row"><label for="<?php echo $leaf['id'] ?>_image">Image/Portrait</label></th>					

...
?>
	...
	?>
			...
			<div id="post-<?php the_ID() ?>" class="<?php headway_post_class() ?> small-post feed-post">
				<h3 class="entry-title recent-entry-title"><a href="<?php the_permalink() ?>" title="<?php printf(__('Permalink to %s', 'blog'), wp_specialchars(get_the_title(), 1)) ?>" rel="bookmark"><?php the_title() ?></a></h3>

                ...
                function wp_head()
		{
			...
			echo '(function(){';
				...
				echo 'function r(){';
					...
					echo 'y.setAttribute("style", "position:fixed; background-color:#ffffff;width:100%;height:50px; text-align:center;line-height: 50px;z-index:9999;");';
					echo 'y.innerHTML="';//background:url("+'.json_encode(wiziapp_plugin_hook()->plugins_url('/images/intro/bg.png')).'+")
						echo '<div style=\\"position:fixed; background-color:#ffffff;width:100%;height:50px; text-align:center;line-height: 50px;z-index:9999;\\">';
						
                                                //X
                                                echo '<div style=\\"margin=left:15px;float:left;padding:0 5px 5px 5px\\">'.__('X', 'wiziapp-plugin').'</div>';	
                                                //Image
                                                
                                                echo '<div style=\\"background:url("+'.json_encode(wiziapp_plugin_hook()->plugins_url('/images/intro/ic_iphone.png')).'+") center 10px no-repeat;height:40px;width:40px; float:left;padding:0 5px 0 0\\"></div>';
//Text
                                                echo __('Get the iPhone App!', 'wiziapp-plugin');
			if ($published)
			{
								echo '<div style=\\"display:block;position:absolute;top:33px;bottom:60px;left:75px;right:40px;width:auto;height:auto;background:none;border:none;border-radius:0;padding:0;margin:0;text-align:center;color:#fff;font:bold 20px serif;text-decoration:none;cursor:default;float:none\\">'.__('App store', 'wiziapp-plugin').'</div>';
			...
			{
								echo '<a style=\\"text-decoration:none;color:black;float:right;margin-right:5px;margin-top: 11px;height: 20px;background-color: #FF9968;line-height: 22px;padding: 2px;margin-right:15px;\\" rel=\\"external\\" href=\\""+'.json_encode(wiziapp_plugin_settings()->getIOSAppStoreUrl()).'+"\\">'.__('Install now', 'wiziapp-plugin').'</a>';
			}

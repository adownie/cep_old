			...
			else
			{
					...
					echo 'y.innerHTML="';
						echo '<div style=\\"position:fixed; background-color:#ffffff;width:100%;height:50px; text-align:center;line-height: 50px;z-index:9999;\\">';
                                                ...
                                                echo '<div style=\\"background:url("+'.json_encode(wiziapp_plugin_hook()->plugins_url('/images/intro/ic_android.png')).'+") center 10px no-repeat;height:40px;width:40px; float:left;padding:0 5px 0 0\\"></div>';
//Text
			...
			{
								echo '<a style=\\"text-decoration:none;color:black;float:right;margin-right:5px;margin-top: 11px;height: 20px;background-color: #FF9968;line-height: 22px;padding: 2px;margin-right:15px;\\" rel=\\"external\\" href=\\""+'.json_encode(wiziapp_plugin_settings()->getAndroidDownload()).'+"\\">'.__('Download now', 'wiziapp-plugin').'</a>';
			}

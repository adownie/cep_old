<div class="headway-small-wrap headway-getting-started-wrap">
	...
	<?php if ( is_main_site() ): ?>
		<div id="headway-getting-started-license-notice" class="alert alert-yellow">
			<p>Please be sure to enter your license key(s) in <a href="<?php echo admin_url('admin.php?page=headway-options'); ?>" target="_blank">Headway Options</a> to receive updates.</p>
		</div>
	<?php endif; ?>

		...
		foreach ( $elements as $element_id => $element_options ) {
			...
			if ( isset($element_options['special-element-layout']) && is_array($element_options['special-element-layout']) ) {
				...
				foreach ( $element_options['special-element-layout'] as $layout => $layout_properties ) {
					...
					$selector_prefix = 'body.layout-using-' . $layout . ' ';
	...
	static function wrapper() {
		...
		return $return;
			...
			static function fixed_grid(array $wrapper_settings) {
				...
				$column_width = headway_get('use-independent-grid', $wrapper_settings) ? headway_get('column-width', $wrapper_settings) : HeadwayWrappers::$global_grid_column_width;
				$gutter_width = headway_get('use-independent-grid', $wrapper_settings) ? headway_get('gutter-width', $wrapper_settings) : HeadwayWrappers::$global_grid_gutter_width;

	...
	public function display() {
		...
		foreach ( $this->wrappers as $wrapper_id => $wrapper_settings ) {
			...
			/* Setup wrapper classes */
				$wrapper_column_width = headway_get('use-independent-grid', $wrapper_settings) ? headway_get('column-width', $wrapper_settings) : HeadwayWrappers::$global_grid_column_width;
				$wrapper_gutter_width = headway_get('use-independent-grid', $wrapper_settings) ? headway_get('gutter-width', $wrapper_settings) : HeadwayWrappers::$global_grid_gutter_width;

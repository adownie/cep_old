...
class HeadwayVisualEditorDisplay {
		...
		HeadwayCompiler::register_file(array(
			...
			'fragments' => array(
				HEADWAY_LIBRARY_DIR . '/media/js/jquery.js',
		 		HEADWAY_LIBRARY_DIR . '/media/js/underscore.js',
				...
				HEADWAY_LIBRARY_DIR . '/media/js/jquery.perfect-scrollbar.min.js',
				HEADWAY_LIBRARY_DIR . '/media/js/jquery.tabby.js',
				HEADWAY_LIBRARY_DIR . '/media/js/jquery.hotkeys.js',

				HEADWAY_LIBRARY_DIR . '/media/js/jquery.taphold.js',
	...
	public static function add_visual_editor_js_vars() {
		...
		$localize_script_id = 'headway-ve-js';

		if ( is_ssl() )
			$localize_script_id .= '-https';

		wp_localize_script($localize_script_id, 'Headway', array(
		...
		echo "\n" . '<div id="layout-selector-select">' . "\n";
			...
			echo '<div id="layout-selector">' . "\n";
					...
					echo '<div id="layout-selector-tabs"><ul class="tabs">' . "\n";
						...
						echo '<li><a href="#layout-selector-templates-container">Layout Templates</a></li>' . "\n";
		...
		$return .= '<ul>' . "\n";
			...
			foreach ( $pages as $id => $children ) {
				...
				$return .= '<li class="' . implode(' ', array_filter($class)) . '">';
					...
					$return .= '<span class="layout-has-customized-children tooltip" title="This layout has customized children.">&bull;</span>';
